...
const EXPERIENCE_ROLES: RoleData[] = [
  {
    ...
    bullets: [
      "As the sole fullstack engineer on this project, built Retention Autopilot, an agentic AI system designed to reduce churn for the small businesses on the platform.",
      "On every customer login, the system pulled usage data, segmented users automatically, and generated targeted campaigns, renewal discounts, feature nudges, ROI summaries, upgrade prompts, or re-engagement tips based on journey stage.",
      "Each campaign shipped with an A/B-tested variant and human approval before launch, driving a 30% improvement in 30-day returning users and a 30% reduction in campaign setup time.",
    ],
    impactHighlights: ["+30% returning users", "-30% setup time", "Human-reviewed AI"],
    stack: ["Agentic AI", "User Segmentation", "A/B Testing", "Retention Campaigns"],
    featured: true,
    statusBadge: "[ ACTIVE ]",
  ...
  },
  {
    ...
    impactHighlights: ["1.1B vs 8B models", "Feedback distillation", "Baseline benchmarking"],
    stack: ["LLMs", "Knowledge Distillation", "Evaluation", "Reasoning"],
    featured: false,
  ...
  },
  {
    ...
    impactHighlights: ["Led 3 interns", "GitHub Actions CI/CD", "+25% engagement"],
    stack: ["MERN", "GitHub Actions", "Stripe", "GPT Tutoring"],
    featured: false,
...
function setHud(
  hud: HudElements,
  values: { phase?: string; role?: string; status?: string; statusTone?: HudTone }
) {
...
export default function DarkModeExperiencesPage() {
