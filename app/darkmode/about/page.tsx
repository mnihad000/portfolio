...
export default async function DarkModeAboutPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-black text-white isolate">
      ...
      <div className="about-ambient-scan pointer-events-none absolute inset-0 bg-[linear-gradient(to_bottom,rgba(255,255,255,0.03)_1px,transparent_1px)] bg-[size:100%_3px] opacity-[0.07]" />
      <div className="about-ambient-light pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.07),transparent_48%)]" />
      <div className="about-ambient-light pointer-events-none absolute -top-24 right-[16%] h-48 w-48 rounded-full bg-emerald-300/6 blur-3xl" />
