...
export default function ThemeToggle({ variant = "dark" }: ThemeToggleProps) {
  ...
  const className = isLightVariant
    ? "group relative flex h-10 min-w-10 items-center justify-center overflow-hidden rounded-full border border-black/10 bg-white/76 text-neutral-900 shadow-[0_10px_24px_rgba(15,23,42,0.08)] backdrop-blur-md transition-all duration-300 hover:border-black/20 hover:text-black disabled:cursor-not-allowed disabled:opacity-65 sm:h-12 sm:min-w-12"
    : "group relative flex h-10 min-w-10 items-center justify-center overflow-hidden rounded-full border border-white/15 bg-white/[0.06] text-white shadow-[0_10px_24px_rgba(0,0,0,0.2)] backdrop-blur-md transition-all duration-300 hover:border-white/25 hover:text-white disabled:cursor-not-allowed disabled:opacity-65 sm:h-11 sm:min-w-11";
