...
export default function ProjectCard({
  ...
  return (
    <Link
      ...
      className="group block w-full max-w-[410px] overflow-hidden rounded-3xl border border-white/15 bg-black/70 transition-all duration-300 hover:-translate-y-0.5 hover:border-white/25 hover:shadow-[0_20px_40px_rgba(0,0,0,0.5)] xl:max-w-[400px]"
    >
      <div className="relative h-[210px] overflow-hidden border-b border-white/10 bg-black/80">
        <Image
      ...
      <article className="flex h-[315px] flex-col gap-3 overflow-hidden p-5 md:h-[325px] md:p-6">
        <div className="space-y-2">
          <h2 className="font-heading text-3xl leading-tight tracking-[0.08em] text-white md:text-4xl">
            {project.title}
          </h2>
        ...
        <p className="overflow-hidden font-mono text-base leading-7 text-white/75 [display:-webkit-box] [-webkit-box-orient:vertical] [-webkit-line-clamp:5]">
          {project.description}
        </p>
